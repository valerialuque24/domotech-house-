...
import 'climatizacio_model.dart';
export 'climatizacio_model.dart';

class ClimatizacioWidget extends StatefulWidget {
  const ClimatizacioWidget({super.key});

  @override
  State<ClimatizacioWidget> createState() => _ClimatizacioWidgetState();
}

class _ClimatizacioWidgetState extends State<ClimatizacioWidget> {
  late ClimatizacioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClimatizacioModel());
